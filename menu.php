<nav class="modulos">
                <div class="modulo azul">
                    ...
                    <ul>
                        ...
                        <li><a href="exercicio.php?dir=API&file=escrevendo_arquivo">Escrevendo Arquivos</a></li>
            ...
            <div class="modulo vermelho">
                    ...
                    <ul>
                        ...
                        <li><a href="exercicio.php?dir=sessao&file=gerenciamento_sessao">Gerenciando Sessão</a></li>
                    </ul>
                </div>
                <div class="modulo verde">
                    <h3>11. Try Catch</h3>
                    <ul>
                        <li><a href="exercicio.php?dir=try_catch&file=try_catch"> Try/Catch</a></li>
                        <li><a href="exercicio.php?dir=try_catch&file=erros_personalizados"> Erros Personalizados</a></li>
                        <li><a href="exercicio.php?dir=try_catch&file=desafio"> Desafio </a></li>
                        <li><a href="exercicio.php?dir=try_catch&file=gerenciador_erro"> Error Handler </a></li>
                    </ul>
                </div>
            ...
            <div class="modulo azul-escuro">
                    ...
                    <ul>
                        ...
                        <li><a href="exercicio.php?dir=classes_objetos&file=desafio_class_data">Desafio Classe Data</a></li>
                        <li><a href="exercicio.php?dir=classes_objetos&file=constr_destru">Construtor e Destrutor</a></li>
                        ...
                        <li><a href="exercicio.php?dir=classes_objetos&file=estatico">Estáticos</a></li>
                        <li><a href="exercicio.php?dir=classes_objetos&file=interface">Interface</a></li>
                        <li><a href="exercicio.php?dir=classes_objetos&file=abstrata">Classe abstract</a></li>
                        ...
                        <li><a href="exercicio.php?dir=classes_objetos&file=traits_01">Traits #02</a></li>
            ...
            <div class="modulo vermelho-escuro">
                    ...
                    <ul>
                        ...
                        <li><a href="exercicio.php?dir=funcoes&file=declara_tipo"> Declarando Tipo Função </a></li>
                        <li><a href="exercicio.php?dir=funcoes&file=Funcao_anoni"> Função Anonima </a></li>
                        ...
                        <li><a href="exercicio.php?dir=funcoes&file=desa_recurs"> Desafio Recursividade </a></li>
                        <li><a href="exercicio.php?dir=funcoes&file=retor_func"> Retornando uma Função </a></li>
